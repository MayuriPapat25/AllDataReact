    ...
    <>
      {
        ...
        <div className="fixed inset-0 z-50">
          ...
          <div className="absolute right-0 top-0 h-full w-full sm:w-[480px] md:w-[800px] bg-light-smoky-white shadow-xl overflow-y-auto">
            <div className="flex items-center justify-between py-4 px-8 border-b">
              ...
              >
                <Icon type="close" className="text-3xl" />
              </Button>
            </div>
