// StepContentRepInitiatedCheckout.stories.jsx
import React, { useState } from "react";
import StepContentRepInitiatedCheckout from "./index";

export default {
    title: "Organisms/StepContentRepInitiatedCheckout",
    component: StepContentRepInitiatedCheckout,
    argTypes: {
...
const Template = (args) => {
    ...
    return (
        <StepContentRepInitiatedCheckout
            {...args}
