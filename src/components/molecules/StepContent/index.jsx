...
const StepContent = ({ currentStep, onContinue, onBack }) => {
    const renderStepContent = () => {
        switch (currentStep) {
            case 1:
                return (<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto relative">
                    <div>
                        <CreateNewAccount onContinue={onContinue} onCancel={onBack} />
                    </div>
