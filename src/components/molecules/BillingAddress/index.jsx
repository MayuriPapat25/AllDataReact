...
const BillingAddressForm = ({ fromReview, onEdit }) => {
    ...
    return (
        <div className={`${!fromReview ? "max-w-4xl pt-6  pb-8 border-b-4 border-gray-300" : "max-w-2xl pt-2  pb-8 border-b-4 border-gray-300"}`}>
            {
                !fromReview ? <h1 className="text-2xl font-bold text-gray-900 mb-4 tracking-wide">BILLING ADDRESS</h1>
                    : <div className="flex items-center justify-between mb-4">
                        <h2 className="text-sm font-semibold text-gray-900 tracking-wide uppercase">BILLING ADDRESS</h2>
